# Implementation Prompt — Write unit and integration tests
...
You are implementing the **Write unit and integration tests** feature.
Follow the specification exactly. Do not add features not described in the spec.

## Files to Reference

- **Specification:** `specs/write-unit-and-integration-tests/specs.md`
- **Requirements Checklist:** `specs/write-unit-and-integration-tests/requirements.md`
...
1. Read `specs/write-unit-and-integration-tests/specs.md` thoroughly before writing any code
2. Implement each requirement from `specs/write-unit-and-integration-tests/requirements.md` one at a time
