# Implementation Prompt — Pending Transaction Filter Engine
...
You are implementing the **Pending Transaction Filter Engine** feature.
Follow the specification exactly. Do not add features not described in the spec.

## Files to Reference

- **Specification:** `specs/pending-transaction-filter-engine/specs.md`
- **Requirements Checklist:** `specs/pending-transaction-filter-engine/requirements.md`
...
1. Read `specs/pending-transaction-filter-engine/specs.md` thoroughly before writing any code
2. Implement each requirement from `specs/pending-transaction-filter-engine/requirements.md` one at a time
